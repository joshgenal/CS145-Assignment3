...
This program is a basic solution to the Towers of Hanoi puzzle. It allows the user
to input the
number of disks they want to play with, up to a limit of 4. It uses recursion to
move the disks
from the starting tower to the destination tower following the rules of the Towers
of Hanoi game.
*/
...
case "N":
isStopped = true;
System.out.println("\nThank you for trying the Towers of Hanoi
Demo!");
break;
case "Y":
...
{
System.out.println("Sorry, that's not a number. Please try
again.");
System.out.print("How many disks do you want to play with? ");
}
}
...
private String solveTowerOfHanoi(int numberOfDisks, int fromTower, int
toTower)
{
StringBuilder solution = new StringBuilder();
if(numberOfDisks == 1)
{
solution.append(fromTower).append(" to Tower
").append(toTower).append(";");
}
else
{
int helpTower = 6 - fromTower - toTower;
solution.append(solveTowerOfHanoi(numberOfDisks - 1, fromTower,
helpTower));
solution.append(fromTower).append(" to Tower
").append(toTower).append(";");
solution.append(solveTowerOfHanoi(numberOfDisks - 1, helpTower,
toTower));
}
